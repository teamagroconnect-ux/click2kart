          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm sticky top-24">
            ...
            <form onSubmit={save} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                {form.bannerImage && (
                  <div className="mb-2">
                    <img src={form.bannerImage} alt="Banner preview" className="w-full h-32 object-cover rounded-xl" />
                  </div>
                )}
                <div className="flex gap-2">
                  <input className="flex-1 bg-gray-50 border-none rounded-2xl px-4 py-3 text-sm font-bold outline-none focus:ring-2 focus:ring-blue-500" placeholder="https://..." value={form.bannerImage} onChange={e => setForm({ ...form, bannerImage: e.target.value })} required />
                  <ImageUpload onUploaded={(url) => setForm({ ...form, bannerImage: url })} />
                </div>
              </div>
              ...
              <div key={o._id} className={`group bg-white border border-gray-100 rounded-3xl p-4 shadow-sm flex gap-6 items-center ${!o.isActive ? 'opacity-50 grayscale' : ''}`}>
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => remove(o._id)} className="p-2 bg-red-50 text-red-500 rounded-xl hover:bg-red-100 transition-all">
                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                      <path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 0 00-1-1h-4a1 0 00-1 1v3M4 7h16" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </button>
                </div>
              </div>
