  ...
  return (
    <div className="space-y-8 max-w-[1600px] mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Retailer Intelligence</h1>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm border-collapse">
            <thead className="bg-gray-50/50 border-b border-gray-50 text-gray-400 font-black uppercase tracking-[0.2em] text-[10px]">
              <tr>
                <th className="px-8 py-5">Retailer Profile</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? (
                ...
                <tr>
                  <td colSpan="6" className="px-8 py-20 text-center text-gray-400 italic font-medium uppercase tracking-[0.2em] text-[10px]">No retailers match your criteria.</td>
                </tr>
              ) : (
                items.map((c) => (
                  <tr key={c._id} className="group hover:bg-gray-50/30 transition-colors cursor-pointer" onClick={()=>location.href=`/admin/retailers/${c._id}`}>
